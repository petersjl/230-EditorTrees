...
public class AddResult {
	...
	public String toString() {
		return "<[" + this.directions[0].toString() + this.directions[1].toString() + "] " + this.rotation + " " + this.node.element + " " + (this.success ? "true" : "false") + ">";
	}
	...
	public void setValues(Node node) {
		...
		this.node = node;
		if (this.directions[0] == Node.Code.LEFT && this.directions[1] == Node.Code.LEFT) this.rotation = Rotation.RIGHT_DOUBLE;
		if (this.directions[0] == Node.Code.LEFT && this.directions[1] == Node.Code.RIGHT) this.rotation = Rotation.RIGHT_SINGLE;

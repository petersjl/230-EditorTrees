...
public class EditTreeMilestone3Test {
	...
	private EditTree makeTrickyTreeForFind() {
		EditTree t = new EditTree();
		for (int i = 0; i < 10; i++) {
			t.add('a');
		}
	...
	@Test
	public void testTrickyString() {
		EditTree t = makeTrickyTreeForFind();

		assertEquals(0, t.find("aaaaaaaaa"));
		assertEquals(1, t.find("aaaaaaaaab"));
		assertEquals(2, t.find("aaaaaaaab"));
